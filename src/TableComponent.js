...
function TableComponent(props) {
  return (
    <div>
              ...
              <tr key={dataDetail.id}>
                {props.editId === dataDetail.id ? (
                  <>
                    ...
                    <td>
                      <button onClick={() => props.handleSave(dataDetail.id)}>
                        Save
                      </button>
                      <button onClick={() => props.handleCancel()}>
                        Cancel
                      </button>
                      <button onClick={() => props.handleDelete(dataDetail.id)}>
                        Delete
                      </button>
                    </td>
                  </>
                  ...
                  <>
                    ...
                    <td>
                      <button onClick={() => props.handleEdit(dataDetail.id)}>
                        Edit
                      </button>
                      <button onClick={() => props.handleDelete(dataDetail.id)}>
                        Delete
      ...
      <h2>
        <Badge pill bg={props.vnClass}>
          {props.vnText}
        </Badge>
        {"     "}
        <Badge pill bg={props.vpClass}>
          {props.vpText}
        </Badge>
      </h2>
